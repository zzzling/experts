...
//     CurrentSymbol = SymbolArray[count];
   ...
   if(Ma5 - Ma8 > 10*PointScale(CurrentSymbol)*MarketInfo(CurrentSymbol,MODE_POINT)  && TimeCurrent() - LastMABuyCrossTime < 60*15 )
   {
      //如果均线在15分钟内就扩大10点，准备开单
   ...
   if(Ma8 - Ma5 > 10*PointScale(CurrentSymbol)*MarketInfo(CurrentSymbol,MODE_POINT)  && TimeCurrent() - LastMASellCrossTime < 60*15)
   {
      //如果均线在15分钟内就扩大10点，准备开单
